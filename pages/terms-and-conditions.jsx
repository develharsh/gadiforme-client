...
const Terms = () => {
  return (
    <>
      <Seo title="Terms &amp; Conditions - www.gadifor.me" />
      <div className="terms-and-conditions">
        <h2>
          <strong>Terms and Conditions</strong>
        </h2>

        <p>Welcome to www.gadifor.me .</p>

        <p>
          These terms and conditions outline the rules and regulations for the
          use of GadiForMe Inc.&apos;s Website, located at
          https://gadifor.me.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use www.gadifor.me if you do not
        ...
        <p>
          We employ the use of cookies. By accessing www.gadifor.me, you
          agreed to use cookies in agreement with the GadiForMe Inc.&apos;s
          Privacy Policy.{" "}
        </p>
        ...
        <p>
          ...
          intellectual property rights for all material on www.gadifor.me.
          All intellectual property rights are reserved. You may access this
          from www.gadifor.me for your own personal use subjected to
          restrictions set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from www.gadifor.me</li>
          <li>Sell, rent or sub-license material from www.gadifor.me</li>
          <li>Reproduce, duplicate or copy material from www.gadifor.me</li>
          <li>Redistribute content from www.gadifor.me</li>
        </ul>
        ...
        <p>
          ...
          and opinions of GadiForMe Inc.,its agents and/or affiliates. Comments
        ...
        <p>
          GadiForMe Inc. reserves the right to monitor all Comments and to
        ...
        <p>
          ...
          sending an e-mail to GadiForMe Inc.. Please include your name, your
