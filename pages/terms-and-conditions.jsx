...
const Terms = () => {
  return (
    <div className="terms-and-conditions">
      ...
      <p>Welcome to www.gadiforme.com .</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of GadiForMe Inc.'s Website, located at https://gadiforme.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use www.gadiforme.com if you do not agree
      ...
      <p>
        We employ the use of cookies. By accessing www.gadiforme.com, you agreed
        to use cookies in agreement with the GadiForMe Inc.'s Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, GadiForMe Inc. and/or its licensors own the
        intellectual property rights for all material on www.gadiforme.com. All
        intellectual property rights are reserved. You may access this from
        www.gadiforme.com for your own personal use subjected to restrictions
        set in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from www.gadiforme.com</li>
        <li>Sell, rent or sub-license material from www.gadiforme.com</li>
        <li>Reproduce, duplicate or copy material from www.gadiforme.com</li>
        <li>Redistribute content from www.gadiforme.com</li>
      </ul>
      ...
      <p>
        ...
        GadiForMe Inc. does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views and
        opinions of GadiForMe Inc.,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, GadiForMe Inc.
      ...
      <p>
        GadiForMe Inc. reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant GadiForMe Inc. a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of GadiForMe Inc.; and (d) the
      ...
      <p>
        ...
        e-mail to GadiForMe Inc.. Please include your name, your organization
      ...
      <p>
        No use of GadiForMe Inc.'s logo or other artwork will be allowed for
